...
<template>
  <div class="grid grid-cols-2 gap-2 text-left">
      <div>
        ...
        <select v-model="modelValue.type" @input="$emit('update:modelValue', modelValue)" class="input-field">
    ...
    <div>
      ...
      <input placeholder="Big Scary Guy" v-model="modelValue.name" @input="$emit('update:modelValue', modelValue)" class="input-field" />
    </div>
